namespace Loveman
{
	partial class FormNewProject
	{
		...
		private void InitializeComponent()
		{
			...
			this.listFeatures = new Nimble.Controls.FlatControls.FlatList();
			...
			this.flatGroupBox2.Controls.Add(this.listFeatures);
			...
			this.flatGroupBox2.Title = "Features";
            ...
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.listFeatures.AutoScroll = true;
			this.listFeatures.AutoScrollMinSize = new System.Drawing.Size(1, 0);
			this.listFeatures.BorderColor = System.Drawing.Color.Black;
			this.listFeatures.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.listFeatures.CheckboxStyle = true;
			this.listFeatures.ClickDeselects = true;
			this.listFeatures.FontSub = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.listFeatures.ForeColorSub = System.Drawing.Color.Gray;
			this.listFeatures.HoverColor = System.Drawing.Color.LightGray;
			this.listFeatures.HoverIndex = -1;
			this.listFeatures.HoverVisible = true;
			this.listFeatures.ItemHeight = 16;
			this.listFeatures.ItemImageSize = 16;
			this.listFeatures.ItemImageSizeSpacing = 4;
			this.listFeatures.ItemPaddingX = 4;
			this.listFeatures.ItemPaddingY = 2;
			this.listFeatures.ItemSubTextSpacing = 4;
			this.listFeatures.Location = new System.Drawing.Point(6, 22);
			...
			this.radioLovr.Margin = new System.Windows.Forms.Padding(4);
			...
			this.radioLove2D.Margin = new System.Windows.Forms.Padding(4);
		...
		private Nimble.Controls.FlatControls.FlatGroupBox flatGroupBox2;
		private Nimble.Controls.FlatControls.FlatList listFeatures;
	}
}