...
namespace Loveman.Features
{
	public class TinyEcs : IFeature
	{
		...
		public void ApplyFeature(ProjectInfo project)
		{
			...
			var tinyPath = Path.Combine(project.GetPath(), "tiny.lua");
			wc.DownloadFile("https://raw.githubusercontent.com/bakpakin/tiny-ecs/master/tiny.lua", tinyPath);
		}
	}
}
