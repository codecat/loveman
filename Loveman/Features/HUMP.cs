...
{
	public class HUMP : IFeature
	{
		public string GetName()
		{
			return "Add HUMP (vrld/hump)";
		}
		...
		public void ApplyFeature(ProjectInfo project)
		{
			...
			wc.Proxy = null;
			var ms = new MemoryStream(wc.DownloadData("https://github.com/vrld/hump/archive/refs/heads/master.zip"));
			...
			for (int i = 0; i < zip.Count; i++) {
				...
				string fname = f.Name.Substring("hump-master/".Length);
